      ...
      {success ? (
        <div className="p-6 text-center space-y-4">
          ...
          <p className="text-sm text-gray-600">
            Please check your email inbox to verify your account and activate your sanctuary profile.
          </p>
          <Link
            href="/login"
            className="inline-block mt-4 px-6 py-3 bg-[#1a392a] text-white rounded-xl text-sm font-medium hover:bg-[#234b37]"
          >
            Proceed to Login
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-[#FDFBF7] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          ...
          <Link
            href="/login"
            className="font-medium text-[#1a392a] hover:underline"
          >
            Sign in
          </Link>
        </p>
